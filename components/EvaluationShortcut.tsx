...
export function EvaluationShortcut() {
  ...
  return (
    <Link className="evaluationShortcut" href="/evaluation" data-no-ui-translate>
      <span>◎</span>
      <div><strong>RAG Evaluation</strong><small>Retrieval · Citation · Date · Abstention</small></div>
      <b>→</b>
      <style jsx global>{`
