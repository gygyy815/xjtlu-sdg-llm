...
4. 不得用“通常”“一般”“大概”“暑假通常到某月”“展览通常有期限”“春季招新通常已结束”等常识补全文档没有写出的结束时间。
5. 如果日期只有“6月17日”这类不含年份的信息，不得自行补成年份；应说明无法确认对应年份。
6. 如果只有文章发布日期而没有活动日期/截止日期，不得据发布日期、当前日期或活动名称推断活动已经结束或仍有效。
7. 如果日期相互冲突，指出冲突并判定“无法确认”，不要自行选择一个日期。
8. 对最终列出的每个活动，说明判断依据所使用的原文日期字段。
9. 如果检索结果不足以支持判断，直接说明“文档未明确说明”或“无法判断”，不要为了完成列表而猜测。
10. 禁止输出“可以推断”“推测”“考虑到……通常有期限，因此可能已经结束”等结论。若你发现自己准备使用这类表达，必须改为“文档没有明确活动/截止日期，无法判断”。
11. 文章发布日期只能用于说明“这篇文章何时发布”，不能作为活动已结束、失效或仍有效的证据。
`;
}
