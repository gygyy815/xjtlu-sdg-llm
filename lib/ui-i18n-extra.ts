...
// Only replace specific phrases; never replace generic Chinese characters, which could
// create a half-English/half-Chinese interface.
const segments: Array<readonly [string, string]> = [
  ...
  ["只决定 Demo 顶部下拉框显示哪些知识库，不必把几十个公众号全部放进去。", "This only controls which knowledge bases appear in the Demo selector; you do not need to list every official account there."],
