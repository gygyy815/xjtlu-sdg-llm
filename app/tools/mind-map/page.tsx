...
export default function MindMapPage() {
  ...
  return <main className="toolPage">
    ...
    {map && <section className="mindCard">
      <div className="mindHead"><div><span>INTERACTIVE MARKMAP</span><h2>{map.title}</h2><p>{map.summary}</p></div><div className="mindActions">
      ...
      <div ref={stageRef} className="markmapStage"><svg ref={svgRef} className="markmapSvg" /></div>
      <div className="mindHelp"><strong>交互提示</strong><span>滚轮缩放</span><span>拖动画布</span><span>点击节点圆点展开/折叠</span><span>SVG 可直接用于报告或继续编辑</span></div>
    </section>}
